...
# Find the path to the source code in 'control_EastRiver.txt'
dest_line=$(grep -m 1 "^install_path_summa" /home/dlhogan/GitHub/mtn_hydro_pysumma/0a_control_files/control_EastRiver.txt) # full settings line
...
if [ "$summa_path" = "default" ]; then
 ...
 root_line=$(grep -m 1 "^root_path" /home/dlhogan/GitHub/mtn_hydro_pysumma/0a_control_files/control_EastRiver.txt)
...
# Find the desired executable name in 'control_EastRiver.txt'
exe_line=$(grep -m 1 "^exe_name_summa" /home/dlhogan/GitHub/mtn_hydro_pysumma/0a_control_files/control_EastRiver.txt) 
